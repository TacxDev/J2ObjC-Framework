...
//  source: android/platform/libcore/luni/src/main/java/org/w3c/dom/Document.java
//

#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_OrgW3cDomDocument")
#ifdef RESTRICT_OrgW3cDomDocument
#define INCLUDE_ALL_OrgW3cDomDocument 0
#else
#define INCLUDE_ALL_OrgW3cDomDocument 1
#endif
...
#if !defined (OrgW3cDomDocument_) && (INCLUDE_ALL_OrgW3cDomDocument || defined(INCLUDE_OrgW3cDomDocument))
#define OrgW3cDomDocument_
...
/*!
 @brief The <code>Document</code> interface represents the entire HTML or XML
...
/*!
 @brief The Document Type Declaration (see <code>DocumentType</code>)
  associated with this document.For XML documents without a document
  type declaration this returns <code>null</code>.
 For HTML documents,
...
/*!
 @brief The <code>DOMImplementation</code> object that handles this document.A
  DOM application may use objects from multiple implementations.
 */
- (id<OrgW3cDomDOMImplementation>)getImplementation;

/*!
 @brief This is a convenience attribute that allows direct access to the child
  node that is the document element of the document.
 */
- (id<OrgW3cDomElement>)getDocumentElement;

/*!
 @brief Creates an element of the type specified.Note that the instance
 ...
 @param tagName The name of the element type to instantiate. For XML,    this is case-sensitive, otherwise it depends on the
...
/*!
 @brief Creates a <code>Text</code> node given the specified string.
...
/*!
 @brief Creates a <code>Comment</code> node given the specified string.
 @param data The data for the node.
...
/*!
 @brief Creates a <code>CDATASection</code> node whose value is the specified
  string.
...
/*!
 @brief Creates a <code>ProcessingInstruction</code> node given the specified
  name and data strings.
 @param target The target part of the processing instruction.Unlike    
  <code> Document.createElementNS </code>  or    
  <code> Document.createAttributeNS </code> , no namespace well-formed    checking is done on the target name. Applications should invoke
      <code>
  Document.normalizeDocument() </code>  with the parameter "    namespaces" set to 
  <code> true </code>  in order to ensure that the    target name is namespace well-formed.
 @param data The data for the node.
...
/*!
 @brief Creates an <code>Attr</code> of the given name.Note that the 
...
/*!
 @brief Creates an <code>EntityReference</code> object.In addition, if the
 ...
 @param name The name of the entity to reference.Unlike    
  <code> Document.createElementNS </code>  or    
  <code> Document.createAttributeNS </code> , no namespace well-formed    checking is done on the entity name. Applications should invoke
      <code>
  Document.normalizeDocument() </code>  with the parameter "    namespaces" set to 
  <code> true </code>  in order to ensure that the    entity name is namespace well-formed.
...
/*!
 @brief Returns a <code>NodeList</code> of all the <code>Elements</code> in
  document order with a given tag name and are contained in the
  document.
 @param tagname The name of the tag to match on. The special value "*"    matches all tags. For XML, the 
  <code> tagname </code>  parameter is    case-sensitive, otherwise it depends on the case-sensitivity of the
...
/*!
 @brief Imports a node from another document to this document, without altering
 ...
 @param deep If  <code> true </code> , recursively import the subtree under
     ...
     itself, as explained above. This has no effect on nodes that cannot    have any children, and on 
  <code> Attr </code> , and     <code>
...
/*!
 @brief Returns a <code>NodeList</code> of all the <code>Elements</code> with a
...
/*!
 @brief Returns the <code>Element</code> that has an ID attribute with the
...
/*!
 @brief An attribute specifying the encoding used for this document at the time
...
/*!
 @brief An attribute specifying, as part of the <a href='http://www.w3.org/TR/2004/REC-xml-20040204#NT-XMLDecl'>XML declaration</a>, the encoding of this document.This is <code>null</code> when
...
/*!
 @brief An attribute specifying, as part of the <a href='http://www.w3.org/TR/2004/REC-xml-20040204#NT-XMLDecl'>XML declaration</a>, whether this document is standalone.This is <code>false</code> when
  unspecified.
...
/*!
 @brief An attribute specifying, as part of the <a href='http://www.w3.org/TR/2004/REC-xml-20040204#NT-XMLDecl'>XML declaration</a>, the version number of this document.If there is no declaration and if
...
/*!
 @brief An attribute specifying whether error checking is enforced or not.When
  ...
  errors while using <code>Document.normalizeDocument()</code>.
 In case
...
/*!
 @brief The location of the document or <code>null</code> if undefined or if
...
/*!
 @brief Attempts to adopt a node from another document to this document.If
  supported, it changes the <code>ownerDocument</code> of the source
  node, its children, as well as the attached attribute nodes if there
  are any.
 If the source node has a parent it is first removed from the
...
/*!
 @brief The configuration used when <code>Document.normalizeDocument()</code>
  is invoked.
 @since DOM Level 3
 */
...
/*!
 @brief This method acts as if the document was going through a save and load
 ...
 <br> Otherwise, the actual result depends on the features being set on the 
 <code>Document.domConfig</code> object and governing what
...
@endcode
 ...
 <br> If errors occur during the invocation of this method, such as an
  ...
  errors or warnings (<code>DOMError.SEVERITY_ERROR_TACX</code> or 
...
/*!
 @brief Rename an existing node of type <code>ELEMENT_NODE</code> or 
 ...
 <br>When the node being renamed is an <code>Attr</code> that is
  attached to an <code>Element</code>, the node is first removed from the 
 <code>Element</code> attributes map. Then, once renamed, either
