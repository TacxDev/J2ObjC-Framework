...
/*!
 @brief The severity of the error, either <code>SEVERITY_WARNING</code>,
  <code>SEVERITY_ERROR_TACX</code>, or <code>SEVERITY_FATAL_ERROR</code>.
 */
- (jshort)getSeverity;
...
@property (readonly, class) jshort SEVERITY_ERROR_TACX NS_SWIFT_NAME(SEVERITY_ERROR_TACX);
@property (readonly, class) jshort SEVERITY_FATAL_ERROR NS_SWIFT_NAME(SEVERITY_FATAL_ERROR);

+ (jshort)SEVERITY_WARNING;

+ (jshort)SEVERITY_ERROR_TACX;
...
/*!
 @brief The severity of the error described by the <code>DOMError</code> is
  error.A <code>SEVERITY_ERROR_TACX</code> may not cause the processing to
  stop if the error can be recovered, unless 
 <code>DOMErrorHandler.handleError()</code> returns <code>false</code>.
 */
inline jshort OrgW3cDomDOMError_get_SEVERITY_ERROR_TACX(void);
#define OrgW3cDomDOMError_SEVERITY_ERROR_TACX 2
J2OBJC_STATIC_FIELD_CONSTANT(OrgW3cDomDOMError, SEVERITY_ERROR_TACX, jshort)
