...
//  source: android/platform/libcore/luni/src/main/java/org/w3c/dom/DOMConfiguration.java
//

#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_OrgW3cDomDOMConfiguration")
#ifdef RESTRICT_OrgW3cDomDOMConfiguration
#define INCLUDE_ALL_OrgW3cDomDOMConfiguration 0
#else
#define INCLUDE_ALL_OrgW3cDomDOMConfiguration 1
#endif
#undef RESTRICT_OrgW3cDomDOMConfiguration
...
#if !defined (OrgW3cDomDOMConfiguration_) && (INCLUDE_ALL_OrgW3cDomDOMConfiguration || defined(INCLUDE_OrgW3cDomDOMConfiguration))
#define OrgW3cDomDOMConfiguration_

@protocol OrgW3cDomDOMStringList;

/*!
 @brief The <code>DOMConfiguration</code> interface represents the configuration
 ...
 <code>CDATASection</code> nodes with <code>Text</code> nodes or
  specifying the type of the schema that must be used when the validation of the 
 ...
 <code>false</code>.</dd>
  ...
  this property and a schema specified in the document instance (i.e. using the 
 <code>schemaLocation</code> attribute) in a schema document (i.e.
 ...
 <code>DOMError.SEVERITY_ERROR_TACX</code> severity, if necessary; 
 </li>
  <li> check if
...
/*!
 ...
 @param value The new value or  <code> null </code>  if the user wishes to
     unset the parameter. While the type of the value parameter is    defined as 
  <code> DOMUserData </code> , the object type must match the    type defined by the definition of the parameter. For example, if
...
/*!
 @brief Return the value of a parameter if known.
...
/*!
 @brief The list of the parameters supported by this 
...
#pragma clang diagnostic pop
#pragma pop_macro("INCLUDE_ALL_OrgW3cDomDOMConfiguration")
