...
//  source: android/platform/libcore/luni/src/main/java/org/w3c/dom/ls/LSSerializer.java
//
...
/*!
 @brief A <code>LSSerializer</code> provides an API for serializing (writing) a
...
/*!
 @brief The <code>DOMConfiguration</code> object used by the 
...
/*!
 @brief The end-of-line sequence of characters to be used in the XML being
  ...
  serialized content is XML 1.1).
 Using other character sequences than
...
/*!
 @brief When the application provides a filter, the serializer will call out
...
/*!
 @brief Serialize the specified node as described above in the general
...
/*!
 @brief A convenience method that acts as if <code>LSSerializer.write</code>
