...
//  source: android/platform/libcore/luni/src/main/java/org/w3c/dom/Text.java
//

#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_OrgW3cDomText")
#ifdef RESTRICT_OrgW3cDomText
#define INCLUDE_ALL_OrgW3cDomText 0
#else
#define INCLUDE_ALL_OrgW3cDomText 1
#endif
...
#if !defined (OrgW3cDomText_) && (INCLUDE_ALL_OrgW3cDomText || defined(INCLUDE_OrgW3cDomText))
#define OrgW3cDomText_
...
/*!
 ...
 If there is markup, it is parsed into the
...
/*!
 @brief Breaks this node into two nodes at the specified <code>offset</code>,
  keeping both in the tree as siblings.After being split, this node
  will contain all the content up to the <code>offset</code> point.
 A
...
/*!
 @brief Returns whether this text node contains <a href='http://www.w3.org/TR/2004/REC-xml-infoset-20040204#infoitem.character'>
...
/*!
 @brief Returns all text of <code>Text</code> nodes logically-adjacent text
...
/*!
 @brief Replaces the text of the current node and all logically-adjacent text
