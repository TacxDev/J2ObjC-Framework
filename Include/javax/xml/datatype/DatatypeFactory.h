...
/*!
 ...
 @param timezone_ of  <code> XMLGregorianCalendar </code>  to be created.
...
- (JavaxXmlDatatypeXMLGregorianCalendar *)newXMLGregorianCalendarWithJavaMathBigInteger:(JavaMathBigInteger *)year
                                                                 ...
                                                                 withJavaMathBigDecimal:(JavaMathBigDecimal *)fractionalSecond
                                                                                withInt:(jint)timezone_ OBJC_METHOD_FAMILY_NONE;
...
/*!
 ...
 @param month of  <code> XMLGregorianCalendar </code>  to be created.
 @param day of  <code> XMLGregorianCalendar </code>  to be created.
 @param timezone_ offset in minutes. <code>DatatypeConstants.FIELD_UNDEFINED</code>  indicates optional field is not set.
