...
#define INCLUDE_ALL_JavaxSqlRowSet 0
#else
#define INCLUDE_ALL_JavaxSqlRowSet 1
#endif
#undef RESTRICT_JavaxSqlRowSet
...
#if !defined (JavaxSqlRowSet_) && (INCLUDE_ALL_JavaxSqlRowSet || defined(INCLUDE_JavaxSqlRowSet))
#define JavaxSqlRowSet_
...
@protocol JavaxSqlRowSetListener;

/*!
 @brief The interface that adds support to the JDBC API for the
...
/*!
 @brief Retrieves the url property this <code>RowSet</code> object will use to
...
/*!
 @brief Sets the URL this <code>RowSet</code> object will use when it uses the 
...
/*!
 @brief Retrieves the logical name that identifies the data source for this 
 <code>RowSet</code> object.
 @return a data source name
 - seealso: #setDataSourceName
 - seealso: #setUrl
 */
- (NSString *)getDataSourceName;

/*!
 @brief Sets the data source name property for this <code>RowSet</code> object to the
  given <code>String</code>.
 <P>
  The value of the data source name property can be used to do a lookup of a 
 <code>DataSource</code> object that has been registered with a naming
 ...
 @throw SQLExceptionif a database access error occurs
 - seealso: #getDataSourceName
 */
- (void)setDataSourceNameWithNSString:(NSString *)name;

/*!
 @brief Retrieves the username used to create a database connection for this 
 <code>RowSet</code> object.
...
/*!
 @brief Sets the username property for this <code>RowSet</code> object to the
  given <code>String</code>.
 @param name a user name
 @throw SQLExceptionif a database access error occurs
 - seealso: #getUsername
 */
- (void)setUsernameWithNSString:(NSString *)name;

/*!
 @brief Retrieves the password used to create a database connection.
...
/*!
 @brief Sets the database password for this <code>RowSet</code> object to
...
/*!
 @brief Retrieves the transaction isolation level set for this 
 <code>RowSet</code> object.
...
/*!
 @brief Sets the transaction isolation level for this <code>RowSet</code> obejct.
...
/*!
 @brief Installs the given <code>java.util.Map</code> object as the default
 ...
 @param map a  <code> java.util.Map </code>  object containing the names of
           SQL user-defined types and the Java classes to which they are          to be mapped
 @throw SQLExceptionif a database access error occurs
 - seealso: #getTypeMap
 */
...
/*!
 @brief Retrieves this <code>RowSet</code> object's command property.
...
/*!
 @brief Sets this <code>RowSet</code> object's command property to the given
  SQL query.
 ...
 - seealso: #getCommand
 */
- (void)setCommandWithNSString:(NSString *)cmd;

/*!
 @brief Retrieves whether this <code>RowSet</code> object is read-only.
...
/*!
 @brief Sets whether this <code>RowSet</code> object is read-only to the
  given <code>boolean</code>.
 @param value <code> true </code>  if read-only;  <code> false </code>
   if         updatable
 @throw SQLExceptionif a database access error occurs
 - seealso: #isReadOnly
 */
...
/*!
 @brief Retrieves the maximum number of bytes that may be returned
...
/*!
 @brief Sets the maximum number of bytes that can be returned for a column
...
/*!
 @brief Retrieves the maximum number of rows that this <code>RowSet</code>
  object can contain.
...
/*!
 @brief Sets the maximum number of rows that this <code>RowSet</code>
...
/*!
 @brief Retrieves whether escape processing is enabled for this 
 <code>RowSet</code> object.
 ...
 @throw SQLExceptionif a database access error occurs
 - seealso: #setEscapeProcessing
 */
- (jboolean)getEscapeProcessing;

/*!
 @brief Sets escape processing for this <code>RowSet</code> object on or
  off.If escape scanning is on (the default), the driver will do
  escape substitution before sending an SQL statement to the database.
 @param enable <code> true </code>  to enable escape processing;
           <code> false </code>  to disable it
 @throw SQLExceptionif a database access error occurs
 - seealso: #getEscapeProcessing
 */
- (void)setEscapeProcessingWithBoolean:(jboolean)enable;

/*!
 @brief Retrieves the maximum number of seconds the driver will wait for
...
/*!
 @brief Sets the maximum time the driver will wait for
...
/*!
 @brief Sets the type of this <code>RowSet</code> object to the given type.
 ...
 @throw SQLExceptionif a database access error occurs
 - seealso: java.sql.ResultSet#getType
 */
- (void)setTypeWithInt:(jint)type;

/*!
 @brief Sets the concurrency of this <code>RowSet</code> object to the given
 ...
 @throw SQLExceptionif a database access error occurs
 - seealso: ResultSet#getConcurrency
 */
- (void)setConcurrencyWithInt:(jint)concurrency;

/*!
 @brief Sets the designated parameter in this <code>RowSet</code> object's SQL
...
/*!
 @brief Sets the designated parameter in this <code>RowSet</code> object's SQL
  ...
  parameters.
 Examples of UDTs include: <code>STRUCT</code>, <code>DISTINCT</code>,
 ...
 @param typeName the fully qualified name of an SQL UDT or the type         name of the SQL structured type being referenced by a 
...
/*!
 @brief Sets the designated parameter in this <code>RowSet</code> object's command
...
/*!
 ...
 @throw SQLExceptionif the driver does not support national
...
/*!
 ...
 @param scaleOrLength for  <code> java.sql.Types.DECIMAL </code>
  ...
  ,           this is the length           of the data in the stream or reader.  For all other types,
            this value will be ignored.
 @throw SQLExceptionif a database access error occurs
 - seealso: java.sql.Types
 */
...
/*!
 ...
 @param inputStream An object that contains the data to set the parameter  value to.
 @param length the number of bytes in the parameter data.
 @throw SQLExceptionif parameterIndex does not correspond
...
/*!
 ...
 @throw SQLExceptionif a database access error occurs, this method is called on
...
/*!
 ...
 @param parameterName the name of the parameter
 @param reader An object that contains the data to set the parameter value to.
 @throw SQLExceptionif a database access error occurs or this method is called on
...
/*!
 @brief Clears the parameters set for this <code>RowSet</code> object's command.
...
/*!
 @brief Fills this <code>RowSet</code> object with data.
 <P>
 ...
 @throw SQLExceptionif a database access error occurs or any of the
...
/*!
 @brief Registers the given listener so that it will be notified of events
 ...
 @param listener a component that has implemented the  <code> RowSetListener </code>
  ...
  <code> RowSet </code>  object
 - seealso: #removeRowSetListener
 */
- (void)addRowSetListenerWithJavaxSqlRowSetListener:(id<JavaxSqlRowSetListener>)listener;

/*!
 @brief Removes the specified listener from the list of components that will be
 ...
 @param listener a component that has been registered as a listener for this         
  <code> RowSet </code>  object
 - seealso: #addRowSetListener
 */
- (void)removeRowSetListenerWithJavaxSqlRowSetListener:(id<JavaxSqlRowSetListener>)listener;
...
/*!
 ...
 @param parameterName the name of the parameter
 @param reader An object that contains the data to set the parameter value to.
 @throw SQLExceptionif the driver does not support national character sets;
...
J2OBJC_EMPTY_STATIC_INIT(JavaxSqlRowSet)

J2OBJC_TYPE_LITERAL_HEADER(JavaxSqlRowSet)
...
#endif
#pragma pop_macro("INCLUDE_ALL_JavaxSqlRowSet")
