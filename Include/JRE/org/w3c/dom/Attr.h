...
//  source: android/platform/libcore/luni/src/main/java/org/w3c/dom/Attr.java
//

#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_OrgW3cDomAttr")
#ifdef RESTRICT_OrgW3cDomAttr
#define INCLUDE_ALL_OrgW3cDomAttr 0
#else
#define INCLUDE_ALL_OrgW3cDomAttr 1
#endif
#undef RESTRICT_OrgW3cDomAttr
...
/*!
 @brief The <code>Attr</code> interface represents an attribute in an 
...
/*!
 @brief Returns the name of this attribute.If <code>Node.localName</code> is
  different from <code>null</code>, this attribute is a qualified name.
 */
- (NSString *)getName;

/*!
 @brief <code>True</code> if this attribute was explicitly given a value in
...
/*!
 @brief On retrieval, the value of the attribute is returned as a string.
...
/*!
 @brief The <code>Element</code> node this attribute is attached to or 
...
/*!
 @brief The type information associated with this attribute.While the type
...
/*!
 @brief Returns whether this attribute is known to be of type ID (i.e.to
