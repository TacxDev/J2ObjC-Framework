...
//  source: android/platform/libcore/luni/src/main/java/org/w3c/dom/NamedNodeMap.java
//

#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_OrgW3cDomNamedNodeMap")
#ifdef RESTRICT_OrgW3cDomNamedNodeMap
#define INCLUDE_ALL_OrgW3cDomNamedNodeMap 0
#else
#define INCLUDE_ALL_OrgW3cDomNamedNodeMap 1
#endif
...
/*!
 @brief Objects implementing the <code>NamedNodeMap</code> interface are used to
...
/*!
 @brief The number of nodes in this map.The range of valid child node indices
