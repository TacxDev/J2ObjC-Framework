...
/*!
 @brief Extended interface for mapping external entity references to input
  sources, or providing a missing external subset.The
  <code>XMLReader.setEntityResolver()</code> method
 ...
 <code>EntityResolver.resolveEntity()</code> method. 
 <blockquote>
 ...
 <code>EntityResolver</code> method will be used. 
 </p>
...
/*!
 @brief Allows applications to provide an external subset for documents
  that don't explicitly define one.Documents with DOCTYPE declarations
  that omit an external subset can thus augment the declarations
  available for validation, entity processing, and attribute processing
  (normalization, defaulting, and reporting types including ID).
 This augmentation is reported
  through the <code>startDTD()</code> method as if
...
/*!
 @brief Allows applications to map references to external entities into input
  sources, or tell the parser it should use conventional URI resolution.
 This method is only called for external entities which have been
  properly declared.
  This method provides more flexibility than the <code>EntityResolver</code>
  interface, supporting implementations of more complex catalogue
  schemes such as the one defined by the <a href="http://www.oasis-open.org/committees/entity/spec-2001-08-06.html">
 ...
 <p>Parsers configured to use this resolver method will call it
  ...
  by <code>getExternalSubset()</code>.
 ...
 <p>Note that the entity naming scheme used here is the same one
  used in the <code>LexicalHandler</code>, or in the <code>ContentHandler.skippedEntity()</code>
  method. </p>
