...
/*!
 ...
 <a href="{@@docRoot}/../technotes/guides/security/crypto/CryptoSpec.html#AppC">
...
/*!
 ...
 @throw InvalidKeyExceptionif the public key in the given
  ...
  files).
 @throw UnsupportedOperationExceptionif (@@code opmode} is 
 <code>WRAP_MODE</code> or <code>UNWRAP_MODE</code> but the mode is not implemented
  by the underlying <code>CipherSpi</code>.
 */
...
/*!
 ...
 <p>If this cipher (including its underlying feedback or padding scheme)
  requires any random bytes (e.g., for parameter generation), it will get
  them using the <code>java.security.SecureRandom</code>
  implementation of the highest-priority
  installed provider as the source of randomness.
  (If none of the installed providers supply an implementation of
  SecureRandom, a system-provided source of randomness will be used.) 
...
/*!
 ...
 @throw UnsupportedOperationExceptionif the corresponding method in the 
