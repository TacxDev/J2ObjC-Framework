...
FOUNDATION_EXPORT JavaSqlSQLTransactionRollbackException *new_JavaSqlSQLTransactionRollbackException_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaSqlSQLTransactionRollbackException *create_JavaSqlSQLTransactionRollbackException_init(void);
...
FOUNDATION_EXPORT JavaSqlSQLTransactionRollbackException *create_JavaSqlSQLTransactionRollbackException_initWithJavaLangThrowable_(JavaLangThrowable *cause);
...
FOUNDATION_EXPORT JavaSqlSQLTransactionRollbackException *create_JavaSqlSQLTransactionRollbackException_initWithNSString_withJavaLangThrowable_(NSString *reason, JavaLangThrowable *cause);
...
FOUNDATION_EXPORT JavaSqlSQLTransactionRollbackException *create_JavaSqlSQLTransactionRollbackException_initWithNSString_withNSString_withJavaLangThrowable_(NSString *reason, NSString *SQLState, JavaLangThrowable *cause);
...
FOUNDATION_EXPORT JavaSqlSQLTransactionRollbackException *create_JavaSqlSQLTransactionRollbackException_initWithNSString_withNSString_withInt_withJavaLangThrowable_(NSString *reason, NSString *SQLState, jint vendorCode, JavaLangThrowable *cause);
