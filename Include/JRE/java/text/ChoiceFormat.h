...
/*!
 @return a copy of the <code>String[]</code> array supplied to the constructor or the most recent
  call to <code>setChoices(double[], String[])</code>.
 */
- (IOSObjectArray *)getFormats;

/*!
 @return a copy of the <code>double[]</code> array supplied to the constructor or the most recent
  call to <code>setChoices(double[], String[])</code>.
 */
...
/*!
 @brief Finds the least double greater than <code>d</code>.
...
/*!
 @brief Finds the least double greater than <code>d</code> (if <code>positive</code> is 
...
/*!
 @brief Finds the greatest double less than <code>d</code>.
 If <code>NaN</code>, returns same value.
 @param d the reference value
...
/*!
 ...
 @param limits contains the top value that you want  parsed with that format, and should be in ascending sorted order. When
   ...
   limit[i]  &le;  X &lt;  limit[i+1].  If the limit array is not in ascending order, the results of formatting  will be incorrect.
