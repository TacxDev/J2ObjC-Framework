...
/*!
 ...
 <a href="Inet6Address.html#scoped">here</a>.
  <p> If the host is <code>null</code> then an <code>InetAddress</code>
...
/*!
 ...
 <p>This method will never do a DNS lookup. Non-numeric addresses are errors. Passing either
  an empty string or a <code>null</code> as the <code>numericAddress</code> will return the 
...
/*!
 @brief Perform class load-time initializations.
...
@interface JavaNetInetAddress_InetAddressHolder : NSObject {
 @public
  /*!
   @brief Reserve the original application specified hostname.
...
- (void)init__WithNSString:(NSString *)hostName
                   withInt:(jint)family OBJC_METHOD_FAMILY_NONE;

@end

J2OBJC_EMPTY_STATIC_INIT(JavaNetInetAddress_InetAddressHolder)

J2OBJC_FIELD_SETTER(JavaNetInetAddress_InetAddressHolder, originalHostName_, NSString *)
