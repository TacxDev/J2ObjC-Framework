...
/*!
 ...
 @return the address to which this socket is bound,
           or the loopback address if denied by the security manager,          or 
...
/*!
 @brief Retrieve setting for <code>SO_TIMEOUT</code>.
 0 returns implies that the option is disabled (i.e., timeout of infinity).
 @return the <code>SO_TIMEOUT</code> value
...
/*!
 @brief Sets a default proposed value for the 
 <code>SO_RCVBUF</code> option for sockets
 ...
 <p>
  The value of <code>SO_RCVBUF</code> is used both to
...
/*!
 ...
 <p>
  Enabling <code>SO_REUSEADDR</code> prior to
  binding the socket using <code>bind(SocketAddress)</code> allows the socket
  to be bound even though a previous connection is in a timeout state. 
 <p>
  When a <code>ServerSocket</code> is created the initial setting
  of <code>SO_REUSEADDR</code> is not defined.
  Applications can use <code>getReuseAddress()</code> to determine the initial
  setting of <code>SO_REUSEADDR</code>.
  <p>
...
/*!
 @brief Enable/disable <code>SO_TIMEOUT</code> with the
...
/*!
 ...
 <code>loopback</code> address is returned as
