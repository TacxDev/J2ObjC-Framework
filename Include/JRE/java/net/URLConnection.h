...
@endcode</blockquote>
  Invoking the <code>close()</code> methods on the <code>InputStream</code> or <code>OutputStream</code> of an 
 <code>URLConnection</code> after a request may free network resources associated with this
...
/*!
 @brief Returns a <code>FileNameMap</code> implementation suitable for guessing a
  content type based on a URL's "file" component.
 - seealso: #guessContentTypeFromName(String)
...
/*!
 ...
 @param n an index, where <code>n>=0</code>
...
/*!
 ...
 <p><strong>Warning</strong>: If the hostname resolves to multiple IP
  addresses, Android's default implementation of <code>HttpURLConnection</code>
  will try each in 
