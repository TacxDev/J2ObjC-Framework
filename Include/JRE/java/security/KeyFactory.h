...
@endcode
 ...
 <table>
  ...
  These algorithms are described in the <a href="{@@docRoot}/../technotes/guides/security/StandardNames.html#KeyFactory">
...
/*!
 ...
 @param algorithm the name of the requested key algorithm.  See the KeyFactory section in the 
  <a href="{@@docRoot}/../technotes/guides/security/StandardNames.html#KeyFactory">
   Java Cryptography Architecture Standard Algorithm Name Documentation
