...
@endcode
 ...
 <table>
  ...
  These types are described in the <a href="{@@docRoot}/../technotes/guides/security/StandardNames.html#KeyStore">
...
/*!
 @brief Returns the default keystore type as specified by the 
 ...
 <code>keystore.type</code> security property, or the string &quot;jks&quot;
  if no such property exists.
...
/*!
 ...
 @param param the <code>LoadStoreParameter</code>           that specifies how to load the keystore,
            which may be 
 <code>null</code>
...
/*!
 ...
 @param param the <code>LoadStoreParameter</code>           that specifies how to store the keystore,
            which may be 
 <code>null</code>
 @throw IllegalArgumentExceptionif the given
           <code>LoadStoreParameter</code>
...
/*!
 @brief Creates a password parameter and specifies the protection algorithm
 ...
 */
- (instancetype __nonnull)initWithCharArray:(IOSCharArray *)password
                               withNSString:(NSString *)protectionAlgorithm
 withJavaSecuritySpecAlgorithmParameterSpec:(id<JavaSecuritySpecAlgorithmParameterSpec>)protectionParameters;
...
/*!
 @brief Gets the name of the protection algorithm.
 If none was set then the keystore provider will use its default
  protection algorithm. The name of the default protection algorithm
  for a given keystore type is set using the 
 <code>'keystore.<type>.keyProtectionAlgorithm'</code> security property.
  For example, the 
 ...
 @since 1.8
 */
- (NSString *)getProtectionAlgorithm;

/*!
 @brief Gets the parameters supplied for the protection algorithm.
 @return the algorithm parameter specification, or <code>null</code>,
      if none was set
 @since 1.8
 */
- (id<JavaSecuritySpecAlgorithmParameterSpec>)getProtectionParameters;
...
FOUNDATION_EXPORT void JavaSecurityKeyStore_PasswordProtection_initWithCharArray_withNSString_withJavaSecuritySpecAlgorithmParameterSpec_(JavaSecurityKeyStore_PasswordProtection *self, IOSCharArray *password, NSString *protectionAlgorithm, id<JavaSecuritySpecAlgorithmParameterSpec> protectionParameters);

FOUNDATION_EXPORT JavaSecurityKeyStore_PasswordProtection *new_JavaSecurityKeyStore_PasswordProtection_initWithCharArray_withNSString_withJavaSecuritySpecAlgorithmParameterSpec_(IOSCharArray *password, NSString *protectionAlgorithm, id<JavaSecuritySpecAlgorithmParameterSpec> protectionParameters) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaSecurityKeyStore_PasswordProtection *create_JavaSecurityKeyStore_PasswordProtection_initWithCharArray_withNSString_withJavaSecuritySpecAlgorithmParameterSpec_(IOSCharArray *password, NSString *protectionAlgorithm, id<JavaSecuritySpecAlgorithmParameterSpec> protectionParameters);
...
FOUNDATION_EXPORT id<JavaUtilSet> JavaSecurityKeyStore_Entry_getAttributes(id<JavaSecurityKeyStore_Entry> self);

J2OBJC_TYPE_LITERAL_HEADER(JavaSecurityKeyStore_Entry)

#endif

#if !defined (JavaSecurityKeyStore_Entry_Attribute_) && (INCLUDE_ALL_JavaSecurityKeyStore || defined(INCLUDE_JavaSecurityKeyStore_Entry_Attribute))
#define JavaSecurityKeyStore_Entry_Attribute_

/*!
 @brief An attribute associated with a keystore entry.
 It comprises a name and one or more values.
 @since 1.8
 */
@protocol JavaSecurityKeyStore_Entry_Attribute < JavaObject >
...
J2OBJC_EMPTY_STATIC_INIT(JavaSecurityKeyStore_Entry_Attribute)

J2OBJC_TYPE_LITERAL_HEADER(JavaSecurityKeyStore_Entry_Attribute)
...
/*!
 ...
 @param chain an array of <code>Certificate</code> s
        representing the certificate chain.       The chain must be ordered and contain a
...
/*!
 @brief Constructs a <code>PrivateKeyEntry</code> with a <code>PrivateKey</code> and
 ...
 @throw NullPointerExceptionif <code>privateKey</code>, <code>chain</code>
...
FOUNDATION_EXPORT void JavaSecurityKeyStore_PrivateKeyEntry_initWithJavaSecurityPrivateKey_withJavaSecurityCertCertificateArray_withJavaUtilSet_(JavaSecurityKeyStore_PrivateKeyEntry *self, id<JavaSecurityPrivateKey> privateKey, IOSObjectArray *chain, id<JavaUtilSet> attributes);

FOUNDATION_EXPORT JavaSecurityKeyStore_PrivateKeyEntry *new_JavaSecurityKeyStore_PrivateKeyEntry_initWithJavaSecurityPrivateKey_withJavaSecurityCertCertificateArray_withJavaUtilSet_(id<JavaSecurityPrivateKey> privateKey, IOSObjectArray *chain, id<JavaUtilSet> attributes) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaSecurityKeyStore_PrivateKeyEntry *create_JavaSecurityKeyStore_PrivateKeyEntry_initWithJavaSecurityPrivateKey_withJavaSecurityCertCertificateArray_withJavaUtilSet_(id<JavaSecurityPrivateKey> privateKey, IOSObjectArray *chain, id<JavaUtilSet> attributes);
...
/*!
 @brief Constructs a <code>SecretKeyEntry</code> with a <code>SecretKey</code> and
  associated entry attributes.
 <p> The specified <code>attributes</code> is cloned before it is stored
  in the new <code>SecretKeyEntry</code> object.
 @param secretKey the <code>SecretKey</code>
 @param attributes the attributes
 @throw NullPointerExceptionif <code>secretKey</code> or
...
FOUNDATION_EXPORT void JavaSecurityKeyStore_SecretKeyEntry_initWithJavaxCryptoSecretKey_withJavaUtilSet_(JavaSecurityKeyStore_SecretKeyEntry *self, id<JavaxCryptoSecretKey> secretKey, id<JavaUtilSet> attributes);

FOUNDATION_EXPORT JavaSecurityKeyStore_SecretKeyEntry *new_JavaSecurityKeyStore_SecretKeyEntry_initWithJavaxCryptoSecretKey_withJavaUtilSet_(id<JavaxCryptoSecretKey> secretKey, id<JavaUtilSet> attributes) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaSecurityKeyStore_SecretKeyEntry *create_JavaSecurityKeyStore_SecretKeyEntry_initWithJavaxCryptoSecretKey_withJavaUtilSet_(id<JavaxCryptoSecretKey> secretKey, id<JavaUtilSet> attributes);
...
/*!
 ...
 @param trustedCert the trusted <code>Certificate</code>
 @param attributes the attributes
 @throw NullPointerExceptionif <code>trustedCert</code> or
      <code>attributes</code> is <code>null</code>
 @since 1.8
 */
- (instancetype __nonnull)initWithJavaSecurityCertCertificate:(JavaSecurityCertCertificate *)trustedCert
...
FOUNDATION_EXPORT void JavaSecurityKeyStore_TrustedCertificateEntry_initWithJavaSecurityCertCertificate_withJavaUtilSet_(JavaSecurityKeyStore_TrustedCertificateEntry *self, JavaSecurityCertCertificate *trustedCert, id<JavaUtilSet> attributes);

FOUNDATION_EXPORT JavaSecurityKeyStore_TrustedCertificateEntry *new_JavaSecurityKeyStore_TrustedCertificateEntry_initWithJavaSecurityCertCertificate_withJavaUtilSet_(JavaSecurityCertCertificate *trustedCert, id<JavaUtilSet> attributes) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaSecurityKeyStore_TrustedCertificateEntry *create_JavaSecurityKeyStore_TrustedCertificateEntry_initWithJavaSecurityCertCertificate_withJavaUtilSet_(JavaSecurityCertCertificate *trustedCert, id<JavaUtilSet> attributes);
...
/*!
 ...
 @throw KeyStoreExceptionif an error occurred during the
