...
/*!
 ...
 <table class="plain">
  ...
  <tbody>
  <tr><td style="text-align:right"><code>T</code></td>
  <th scope="row" style="font-weight:normal; text-align:left"><code>getAnnotation(Class&lt;T&gt;)</code>
  <td></td><td></td><td style="text-align:center">X</td><td></td>
  </tr>
  <tr><td style="text-align:right"><code>Annotation[]</code></td>
  <th scope="row" style="font-weight:normal; text-align:left"><code>getAnnotations()</code>
  <td></td><td></td><td style="text-align:center">X</td><td></td>
  </tr>
  <tr><td style="text-align:right"><code>T[]</code></td>
  <th scope="row" style="font-weight:normal; text-align:left"><code>getAnnotationsByType(Class&lt;T&gt;)</code>
  <td></td><td></td><td></td><td style="text-align:center">X</td>
  </tr>
  <tr><td style="text-align:right"><code>T</code></td>
  <th scope="row" style="font-weight:normal; text-align:left"><code>getDeclaredAnnotation(Class&lt;T&gt;)</code>
  <td style="text-align:center">X</td><td></td><td></td><td></td>
  </tr>
  <tr><td style="text-align:right"><code>Annotation[]</code></td>
  <th scope="row" style="font-weight:normal; text-align:left"><code>getDeclaredAnnotations()</code>
  <td style="text-align:center">X</td><td></td><td></td><td></td>
  </tr>
  <tr><td style="text-align:right"><code>T[]</code></td>
  <th scope="row" style="font-weight:normal; text-align:left"><code>getDeclaredAnnotationsByType(Class&lt;T&gt;)</code>
