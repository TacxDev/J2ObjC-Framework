...
/*!
 @brief J2ObjC split of NioUtils to move method to jre_channels subset library.
...
FOUNDATION_EXPORT void JavaNioChannelFactoryImpl_initPackagePrivate(JavaNioChannelFactoryImpl *self);

FOUNDATION_EXPORT JavaNioChannelFactoryImpl *new_JavaNioChannelFactoryImpl_initPackagePrivate(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaNioChannelFactoryImpl *create_JavaNioChannelFactoryImpl_initPackagePrivate(void);
