...
//  source: android/platform/libcore/ojluni/src/main/java/java/nio/IntBuffer.java
//
...
/*!
 ...
 <p> Int buffers can be created either by <code><i>allocation</i></code>
 ...
 <p> Like a byte buffer, an int buffer is either <a href="ByteBuffer.html#direct">
 <i>direct</i> or <i>non-direct</i></a>.  A
  ...
  an int buffer is direct may be determined by invoking the <code>isDirect</code>
  method.  </p>
...
/*!
 @brief Allocates a new int buffer.
...
/*!
 @brief Returns the int array that backs this
...
/*!
 @brief Creates a new, read-only int buffer that shares this buffer's
  content.
 ...
 */
- (jint)compareToWithId:(JavaNioIntBuffer *)that;

/*!
 @brief Creates a new int buffer that shares this buffer's content.
 <p> The content of the new buffer will be that of this buffer.  Changes
...
/*!
 @brief Relative <i>get</i> method.Reads the int at this buffer's
...
/*!
 @brief Absolute <i>get</i> method.Reads the int at the given
  index.
...
/*!
 ...
 <tt>length</tt>&nbsp;<tt>&gt;</tt>&nbsp;<tt>remaining()</tt>, then no
  ints are transferred and a <code>BufferUnderflowException</code> is
  thrown. 
...
/*!
 @brief Tells whether or not this buffer is backed by an accessible int
  array.
...
/*!
 @brief Tells whether or not this int buffer is direct.
...
/*!
 ...
 <p> The byte order of an int buffer created by allocation or by
  wrapping an existing <tt>int</tt> array is the <code>native order</code>
  of the underlying
  hardware.  The byte order of an int buffer created as a <a href="ByteBuffer.html#views">
...
/*!
 ...
 <tt>length</tt>&nbsp;<tt>&gt;</tt>&nbsp;<tt>remaining()</tt>, then no
  ints are transferred and a <code>BufferOverflowException</code> is
  thrown. 
...
/*!
 ...
 <tt>src.remaining()</tt>&nbsp;<tt>&gt;</tt>&nbsp;<tt>remaining()</tt>,
  then no ints are transferred and a <code>BufferOverflowException</code>
  is thrown. 
...
/*!
 @brief Creates a new int buffer whose content is a shared subsequence of
...
/*!
 @brief Wraps an int array into a buffer.
...
J2OBJC_FIELD_SETTER(JavaNioIntBuffer, hb_, IOSIntArray *)

FOUNDATION_EXPORT void JavaNioIntBuffer_initWithInt_withInt_withInt_withInt_withIntArray_withInt_(JavaNioIntBuffer *self, jint mark, jint pos, jint lim, jint cap, IOSIntArray *hb, jint offset);

FOUNDATION_EXPORT void JavaNioIntBuffer_initWithInt_withInt_withInt_withInt_(JavaNioIntBuffer *self, jint mark, jint pos, jint lim, jint cap);

FOUNDATION_EXPORT JavaNioIntBuffer *JavaNioIntBuffer_allocateWithInt_(jint capacity);

FOUNDATION_EXPORT JavaNioIntBuffer *JavaNioIntBuffer_wrapWithIntArray_withInt_withInt_(IOSIntArray *array, jint offset, jint length);
