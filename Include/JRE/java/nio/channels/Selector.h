...
//  source: android/platform/libcore/ojluni/src/main/java/java/nio/channels/Selector.java
//
...
/*!
 @brief A multiplexor of <code>SelectableChannel</code> objects.
 <p> A selector may be created by invoking the <code>open</code> method of
  this class, which will use the system's default <code>selector provider</code>
  to
 ...
 <p> A key is added to a selector's key set as a side effect of registering a
  channel via the channel's <code>register</code>
 ...
 <p> During each selection operation, keys may be added to and removed from a
  ...
  cancelled-key sets.  Selection is performed by the <code>select()</code>, <code>select(long)</code>
 , and <code>selectNow()</code> methods, and involves three steps: 
 </p>
 ...
 <ul>
    ...
    <li><p> By invoking the selector's <code>close</code> method, or
    </p></li>
    <li><p> By invoking the blocked thread's <code>interrupt</code>
  method, in which case its
    interrupt status will be set and the selector's <code>wakeup</code>
...
/*!
 ...
 <p> If a thread is currently blocked in one of this selector's selection
  methods then it is interrupted as if by invoking the selector's <code>wakeup</code>
  method. 
 ...
 <p> After a selector is closed, any further attempt to use it, except by
  invoking this method or the <code>wakeup</code> method, will cause a 
 <code>ClosedSelectorException</code> to be thrown. </p>
 @throw IOException
...
/*!
 @brief Returns this selector's key set.
...
/*!
 ...
 <p> The new selector is created by invoking the <code>openSelector</code>
  method
  of the system-wide default <code>java.nio.channels.spi.SelectorProvider</code>
  object.  </p>
...
/*!
 @brief Selects a set of keys whose corresponding channels are ready for I/O
  operations.
 <p> This method performs a blocking <a href="#selop">selection
  operation</a>.  It returns only after at least one channel is selected,
  this selector's <code>wakeup</code> method is invoked, or the current
...
/*!
 ...
 <p> This method performs a blocking <a href="#selop">selection
  operation</a>.  It returns only after at least one channel is selected,
  this selector's <code>wakeup</code> method is invoked, the current
...
/*!
 @brief Returns this selector's selected-key set.
...
/*!
 ...
 <p> Invoking this method clears the effect of any previous invocations
  of the <code>wakeup</code> method.  </p>
...
FOUNDATION_EXPORT JavaNioChannelsSelector *JavaNioChannelsSelector_open(void);
