...
//  source: /Users/nestseraualia/devel/j2objc-aleks/guava/android/build_result/java/com/google/common/collect/LexicographicalOrdering.java
//
...
- (id<JavaLangIterable>)maxWithId:(id)arg0
                           withId:(id)arg1;
...
- (id<JavaLangIterable>)minWithId:(id)arg0
                           withId:(id)arg1;
...
- (instancetype)initPackagePrivateWithJavaUtilComparator:(id<JavaUtilComparator>)elementOrder;
