...
/*!
 @brief Construct a DateFormatSymbols object by loading format data from
  resources for the default <code>FORMAT</code>
  locale.It is recommended that the <code>getInstance</code> method is used
  instead.
 <p>This is equivalent to calling 
 <code>DateFormatSymbols(Locale.getDefault(Locale.Category.FORMAT))</code>
 .
 - seealso: #getInstance()
...
/*!
 ...
 <code>getInstance</code> method is used instead.
...
/*!
 @brief Gets the <code>DateFormatSymbols</code> instance for the default
  locale.
 <p>This is equivalent to calling <code>getInstance(Locale.getDefault(Locale.Category.FORMAT))</code>
 .
 - seealso: java.util.Locale#getDefault(java.util.Locale.Category)
 - seealso: java.util.Locale.Category#FORMAT
...
/*!
 ...
 <p>If the language requires different forms for formatting and
  ...
  form. This method returns <code>"ledna"</code> in this case. Refer
...
/*!
 ...
 <p>If the language requires different forms for formatting and
  ...
  form. This method returns <code>"de gen."</code> in this case. Refer
  to the <a href="http://unicode.org/reports/tr35/#Calendar_Elements">
  Calendar Elements in the Unicode Locale Data Markup Language
  (LDML) specification</a> for more details.
