...
//  source: android/platform/libcore/ojluni/src/main/java/java/nio/FloatBuffer.java
//
...
/*!
 ...
 <p> Float buffers can be created either by <code><i>allocation</i></code>
 ...
 <p> Like a byte buffer, a float buffer is either <a href="ByteBuffer.html#direct">
 <i>direct</i> or <i>non-direct</i></a>.  A
  ...
  a float buffer is direct may be determined by invoking the <code>isDirect</code>
  method.  </p>
...
/*!
 @brief Allocates a new float buffer.
...
/*!
 @brief Returns the float array that backs this
...
/*!
 @brief Creates a new, read-only float buffer that shares this buffer's
  content.
...
/*!
 ...
 <p> Two float buffers are compared by comparing their sequences of
  ...
  Pairs of <code>float</code> elements are compared as if by invoking 
 <code>Float.compare(float,float)</code>, except that 
 <code>-0.0</code> and <code>0.0</code> are considered to be equal. 
 <code>Float.NaN</code> is considered by this method to be equal
  to itself and greater than all other <code>float</code> values
 ...
 */
- (jint)compareToWithId:(JavaNioFloatBuffer *)that;

/*!
 @brief Creates a new float buffer that shares this buffer's content.
 <p> The content of the new buffer will be that of this buffer.  Changes
...
/*!
 ...
 <li><p> The two sequences of remaining elements, considered
    ...
    This method considers two float elements <code>a</code> and <code>b</code>
    to be equal if   
 <code>(a == b) || (Float.isNaN(a) && Float.isNaN(b))</code>.
    The values <code>-0.0</code> and <code>+0.0</code> are considered to be
    equal, unlike <code>Float.equals(Object)</code>.
    </p></li>
...
/*!
 @brief Relative <i>get</i> method.Reads the float at this buffer's
...
/*!
 ...
 <tt>length</tt>&nbsp;<tt>&gt;</tt>&nbsp;<tt>remaining()</tt>, then no
  floats are transferred and a <code>BufferUnderflowException</code> is
  thrown. 
...
/*!
 @brief Absolute <i>get</i> method.Reads the float at the given
  index.
...
/*!
 @brief Tells whether or not this buffer is backed by an accessible float
  array.
...
/*!
 @brief Tells whether or not this float buffer is direct.
...
/*!
 ...
 <p> The byte order of a float buffer created by allocation or by
  wrapping an existing <tt>float</tt> array is the <code>native order</code>
  of the underlying
  hardware.  The byte order of a float buffer created as a <a href="ByteBuffer.html#views">
...
/*!
 ...
 <tt>length</tt>&nbsp;<tt>&gt;</tt>&nbsp;<tt>remaining()</tt>, then no
  floats are transferred and a <code>BufferOverflowException</code> is
  thrown. 
...
/*!
 ...
 <tt>src.remaining()</tt>&nbsp;<tt>&gt;</tt>&nbsp;<tt>remaining()</tt>,
  then no floats are transferred and a <code>BufferOverflowException</code>
  is thrown. 
...
/*!
 @brief Creates a new float buffer whose content is a shared subsequence of
...
/*!
 @brief Wraps a float array into a buffer.
...
J2OBJC_FIELD_SETTER(JavaNioFloatBuffer, hb_, IOSFloatArray *)

FOUNDATION_EXPORT void JavaNioFloatBuffer_initWithInt_withInt_withInt_withInt_withFloatArray_withInt_(JavaNioFloatBuffer *self, jint mark, jint pos, jint lim, jint cap, IOSFloatArray *hb, jint offset);

FOUNDATION_EXPORT void JavaNioFloatBuffer_initWithInt_withInt_withInt_withInt_(JavaNioFloatBuffer *self, jint mark, jint pos, jint lim, jint cap);

FOUNDATION_EXPORT JavaNioFloatBuffer *JavaNioFloatBuffer_allocateWithInt_(jint capacity);

FOUNDATION_EXPORT JavaNioFloatBuffer *JavaNioFloatBuffer_wrapWithFloatArray_withInt_withInt_(IOSFloatArray *array, jint offset, jint length);
