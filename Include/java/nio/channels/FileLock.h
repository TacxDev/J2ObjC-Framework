...
/*!
 ...
 <p> A file-lock object is created each time a lock is acquired on a file via
  ...
  methods of the 
 <code>FileChannel</code> class, or the <code>lock</code>
  or <code>tryLock</code>
  methods of the <code>AsynchronousFileChannel</code> class. 
...
/*!
 ...
 @since 1.7
 */
- (instancetype __nonnull)initWithJavaNioChannelsAsynchronousFileChannel:(JavaNioChannelsAsynchronousFileChannel *)channel
...
FOUNDATION_EXPORT void JavaNioChannelsFileLock_initWithJavaNioChannelsAsynchronousFileChannel_withLong_withLong_withBoolean_(JavaNioChannelsFileLock *self, JavaNioChannelsAsynchronousFileChannel *channel, jlong position, jlong size, jboolean shared);
