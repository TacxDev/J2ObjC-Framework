...
FOUNDATION_EXPORT JavaNioChannelsReadPendingException *new_JavaNioChannelsReadPendingException_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaNioChannelsReadPendingException *create_JavaNioChannelsReadPendingException_init(void);
