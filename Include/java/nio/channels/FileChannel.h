...
/*!
 ...
 .  The file itself contains a variable-length sequence
  ...
  decreases when it is <code><i>truncated</i></code>.  The
 ...
 <p> A file channel is created by invoking one of the <code>open</code>
...
/*!
 @brief Opens or creates a file, returning a file channel to access the file.
 <p> An invocation of this method behaves in exactly the same way as the invocation 
 @code

      fc.<code>open</code>(file, opts, new FileAttribute&lt;?&gt;[0]);
   
@endcode
  where <code>opts</code> is a set of the options specified in the <code>options</code>
  array.
 ...
 If the <code>path</code> is associated with a provider that does not
 ...
 @since 1.7
 */
+ (JavaNioChannelsFileChannel *)openWithJavaNioFilePath:(id<JavaNioFilePath>)path
...
/*!
 ...
 <p> The <code>options</code> parameter determines how the file is opened.
  ...
  writing. If neither option (or the <code>APPEND</code>
...
J2OBJC_STATIC_INIT(JavaNioChannelsFileChannel)

FOUNDATION_EXPORT void JavaNioChannelsFileChannel_init(JavaNioChannelsFileChannel *self);

FOUNDATION_EXPORT JavaNioChannelsFileChannel *JavaNioChannelsFileChannel_openWithJavaNioFilePath_withJavaUtilSet_withJavaNioFileAttributeFileAttributeArray_(id<JavaNioFilePath> path, id<JavaUtilSet> options, IOSObjectArray *attrs);

FOUNDATION_EXPORT JavaNioChannelsFileChannel *JavaNioChannelsFileChannel_openWithJavaNioFilePath_withJavaNioFileOpenOptionArray_(id<JavaNioFilePath> path, IOSObjectArray *options);
