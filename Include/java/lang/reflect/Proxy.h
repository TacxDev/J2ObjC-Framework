...
/*!
 ...
 @throw IllegalArgumentExceptionif the argument is not a
           proxy instance
 @throw SecurityExceptionif a security manager, <em>s</em>, is present
           and the caller's class loader is not the same as or an
           ancestor of the class loader for the invocation handler
           and invocation of <code>s.checkPackageAccess()</code>
...
/*!
 ...
 If any of the given interfaces
...
@endcode
 ...
 <ul>
              <li> the given <code>loader</code> is <code>null</code> and
              the caller's class loader is not <code>null</code> and the
              invocation of <code>s.checkPermission</code>
  with
              <code>RuntimePermission("getClassLoader")</code> permission
              denies access.</li>
              <li> for each proxy interface, <code>intf</code>,
              the caller's class loader is not the same as or an
              ancestor of the class loader for <code>intf</code> and
              invocation of <code>s.checkPackageAccess()</code>
  denies access to <code>intf</code>.</li>
           </ul>
...
/*!
 ...
 <code>s.checkPermission</code> with
...
/*!
 ...
 @throw NullPointerExceptionif the given invocation handler, <code>h</code>,
          is <code>null</code>.
 */
