...
/*!
 @brief Soft reference objects, which are cleared at the discretion of the garbage collector in response
  to memory demand.
 <p>Suppose that the garbage collector determines at a certain point in time that an object is <a href="package-summary.html#reachability">
 softly reachable</a>. At that time it may choose to
 ...
 <p>Most applications should use an <code>android.util.LruCache</code> instead of soft references.
...
/*!
 @brief Creates a new soft reference that refers to the given object.The new reference is not
...
/*!
 @brief Creates a new soft reference that refers to the given object and is registered with the given
  queue.
 @param referent object the new soft reference will refer to
