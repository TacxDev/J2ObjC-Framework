...
/*!
 @brief The <code>DataInput</code> interface provides
  ...
  the Java primitive types.There is also a
...
/*!
 @brief Reads some bytes from an input
...
/*!
 @brief Makes an attempt to skip over 
 <code>n</code> bytes
...
/*!
 @brief Reads one input byte and returns 
...
/*!
 @brief Reads and returns one input byte.
...
/*!
 @brief Reads one input byte, zero-extends
...
/*!
 @brief Reads two input bytes and returns
...
/*!
 @brief Reads two input bytes and returns a <code>char</code> value.
 Let <code>a</code>
  be the first byte read and <code>b</code>
...
/*!
 @brief Reads four input bytes and returns an 
...
/*!
 @brief Reads eight input bytes and returns
...
/*!
 @brief Reads four input bytes and returns
...
/*!
 @brief Reads the next line of text from the input stream.
...
/*!
 @brief Reads in a string that has been encoded using a 
 <a href="#modified-utf-8">modified UTF-8</a>
  format.
...
@endcode
 ...
 @throw EOFExceptionif this stream reaches the end
