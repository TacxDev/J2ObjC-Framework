...
/*!
 @brief Fields and units specific to the ISO-8601 calendar system, including quarter-of-year and
  week-based-year.
 <p>This class defines fields and units that are specific to the ISO calendar system. 
 <h3>Quarter of year</h3>
  The ISO-8601 standard is based on the standard civic 12 month year. This is commonly divided into
  four quarters, often abbreviated as Q1, Q2, Q3 and Q4. 
 <p>January, February and March are in Q1. April, May and June are in Q2. July, August and
  September are in Q3. October, November and December are in Q4. 
 <p>The complete date is expressed using three fields: 
 <ul>
    <li><code>DAY_OF_QUARTER</code> - the day within the quarter, from 1 to 90, 91 or 92
    <li><code>QUARTER_OF_YEAR</code> - the quarter within the year, from 1 to 4
    <li><code>YEAR</code> - the standard ISO year 
 </ul>
  
 <h3>Week based years</h3>
  The ISO-8601 standard was originally intended as a data interchange format, defining a string
  format for dates and times. However, it also defines an alternate way of expressing the date,
  based on the concept of week-based-year. 
 <p>The date is expressed using three fields: 
 <ul>
    <li><code>DAY_OF_WEEK</code> - the standard field defining the day-of-week
 ...
 <li><code>WEEK_OF_WEEK_BASED_YEAR</code> - the week within the week-based-year
  ...
  The week-based-year itself is defined relative to the standard ISO proleptic year. It differs
  from the standard year in that it always starts on a Monday. 
 <p>The first week of a week-based-year is the first Monday-based week of the standard ISO year
 ...
 <ul>
    ...
    <li>If January 1st is Wednesday then week 1 starts on December 30th of the previous standard
        year   
 <li>If January 1st is Thursday then week 1 starts on December 29th of the previous standard
        year   
...
+ (jboolean)isIsoWithJavaTimeTemporalTemporalAccessor:(id<JavaTimeTemporalTemporalAccessor>)temporal;
...
FOUNDATION_EXPORT jboolean JavaTimeTemporalIsoFields_isIsoWithJavaTimeTemporalTemporalAccessor_(id<JavaTimeTemporalTemporalAccessor> temporal);
