...
/*!
 ...
 <p>
  Example: 
 <code>DatagramSocket s = new DatagramSocket(null);
               s.bind(new InetSocketAddress(8888));</code>
  Which is equivalent to: 
 <code>DatagramSocket s = new DatagramSocket(8888);</code>
...
/*!
 @brief Binds this DatagramSocket to a specific address and port.
 <p>
...
/*!
 @brief Get value of the SO_RCVBUF option for this <code>DatagramSocket</code>, that is the
...
/*!
 @brief Get value of the SO_SNDBUF option for this <code>DatagramSocket</code>, that is the
