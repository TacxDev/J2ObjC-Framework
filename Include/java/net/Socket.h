...
/*!
 ...
 <p>
  ...
  (see <code>InetAddress.isAnyLocalAddress</code><code>()</code>).
  <p>
...
/*!
 ...
 <code>InetAddress.getByName</code><code>(null)</code>.
...
/*!
 ...
 @param host the host name, or <code>null</code>  for the loopback address.
 @param port the port number.
 @param stream a <code>boolean</code>  indicating whether this is                       a stream socket or a datagram socket.
 @throw IOExceptionif an I/O error occurs when creating the socket.
 @throw SecurityExceptionif a security manager exists and its
              <code>checkConnect</code> method doesn't allow the operation.
 @throw IllegalArgumentExceptionif the port parameter is outside
...
/*!
 @brief Tests if <code>SO_KEEPALIVE</code> is enabled.
 @return a <code>boolean</code> indicating whether or not
          <code>SO_KEEPALIVE</code> is enabled.
...
/*!
 ...
 <p>
  ...
  if the operation is allowed. If the operation is not allowed, the 
 <code>loopback</code> address is returned.
...
/*!
 ...
 <code>loopback</code> address and the local
...
/*!
 @brief Tests if <code>SO_OOBINLINE</code> is enabled.
 @return a <code>boolean</code> indicating whether or not
          <code>SO_OOBINLINE</code>is enabled.
 @throw SocketExceptionif there is an error
  in the underlying protocol, such as a TCP error.
 @since 1.4
...
/*!
 @brief Tests if <code>SO_REUSEADDR</code> is enabled.
 @return a <code>boolean</code> indicating whether or not
          <code>SO_REUSEADDR</code> is enabled.
 @throw SocketExceptionif there is an error
  in the underlying protocol, such as a TCP error.
 @since 1.4
...
/*!
 @brief Get value of the <code>SO_SNDBUF</code> option
  for this <code>Socket</code>, that is the buffer size used by the platform
  for output on this <code>Socket</code>.
 @return the value of the <code>SO_SNDBUF</code>
          option for this <code>Socket</code>.
 @throw SocketExceptionif there is an error
  in the underlying protocol, such as a TCP error.
...
/*!
 @brief Returns setting for <code>SO_LINGER</code>
 .
 -1 returns implies that the
  option is disabled.
  The setting only affects socket close.
 @return the setting for <code>SO_LINGER</code>.
 @throw SocketExceptionif there is an error
  in the underlying protocol, such as a TCP error.
 @since JDK1.1
...
/*!
 @brief Returns setting for <code>SO_TIMEOUT</code>.
 0 returns implies that the option is disabled (i.e., timeout of infinity).
 @return the setting for <code>SO_TIMEOUT</code>
 @throw SocketExceptionif there is an error
  in the underlying protocol, such as a TCP error.
 @since JDK1.1
...
/*!
 @brief Tests if <code>TCP_NODELAY</code> is enabled.
 @return a <code>boolean</code> indicating whether or not
          <code>TCP_NODELAY</code> is enabled.
 @throw SocketExceptionif there is an error
  in the underlying protocol, such as a TCP error.
 @since JDK1.1
...
/*!
 @brief Enable/disable <code>SO_KEEPALIVE</code>.
...
/*!
 @brief Enable/disable <code>SO_OOBINLINE</code>
...
/*!
 @brief Sets the <code>SO_RCVBUF</code> option to the
  specified value for this <code>Socket</code>.The
  <code>SO_RCVBUF</code> option is
  used by the platform's networking code as a hint for the size to set
  the underlying network I/O buffers.
 <p>Increasing the receive buffer size can increase the performance of
  network I/O for high-volume connection, while decreasing it can
  help reduce the backlog of incoming data. 
 <p>Because <code>SO_RCVBUF</code> is a hint,
  applications that want to verify what size the buffers were set to
  should call <code>getReceiveBufferSize()</code>.
  
 <p>The value of <code>SO_RCVBUF</code> is also used
...
/*!
 @brief Enable/disable the <code>SO_REUSEADDR</code>
  socket option.
 <p>
 ...
 <p>
  Enabling <code>SO_REUSEADDR</code>
  prior to binding the socket using <code>bind(SocketAddress)</code> allows
 ...
 <p>
  The behaviour when <code>SO_REUSEADDR</code> is
  enabled or disabled after a socket is bound (See <code>isBound()</code>)
  is not defined.
 @param on whether to enable or disable the socket option
 @throw SocketExceptionif an error occurs enabling or
             disabling the <code>SO_REUSEADDR</code>
...
/*!
 @brief Sets the <code>SO_SNDBUF</code> option to the
  specified value for this <code>Socket</code>.
 The <code>SO_SNDBUF</code> option is used by the
  platform's networking code as a hint for the size to set the underlying
  network I/O buffers. 
 <p>Because <code>SO_SNDBUF</code> is a hint,
  applications that want to verify what size the buffers were set to
  should call <code>getSendBufferSize()</code>.
 @throw SocketExceptionif there is an error
  in the underlying protocol, such as a TCP error.
...
/*!
 @brief Enable/disable <code>SO_LINGER</code> with the
...
/*!
 @brief Enable/disable <code>SO_TIMEOUT</code>
...
/*!
 @brief Enable/disable <code>TCP_NODELAY</code>
