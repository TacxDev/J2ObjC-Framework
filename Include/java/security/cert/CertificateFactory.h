...
@endcode
 ...
 <table>
  ...
  The type and encodings are described in the <a href="{@@docRoot}/../technotes/guides/security/StandardNames.html#CertificateFactory">
  CertificateFactory section</a> and the <a href="{@@docRoot}/../technotes/guides/security/StandardNames.html#CertPathEncodings">
