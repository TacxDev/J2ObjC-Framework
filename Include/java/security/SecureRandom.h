...
/*!
 ...
 @return a strong <code>SecureRandom</code> implementation
 @throw NoSuchAlgorithmExceptionif no algorithm is available
 - seealso: Security#getProperty(String)
 @since 1.8
 */
+ (JavaSecuritySecureRandom *)getInstanceStrong;
...
FOUNDATION_EXPORT JavaSecuritySecureRandom *JavaSecuritySecureRandom_getInstanceStrong(void);
