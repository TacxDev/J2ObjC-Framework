...
//  source: android/platform/libcore/ojluni/src/main/java/java/sql/SQLDataException.java
//
...
/*!
 @brief Constructs a <code>SQLDataException</code> object.
...
/*!
 @brief Constructs a <code>SQLDataException</code> object with a given 
 <code>reason</code>.
...
FOUNDATION_EXPORT JavaSqlSQLDataException *new_JavaSqlSQLDataException_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaSqlSQLDataException *create_JavaSqlSQLDataException_init(void);
...
FOUNDATION_EXPORT JavaSqlSQLDataException *create_JavaSqlSQLDataException_initWithJavaLangThrowable_(JavaLangThrowable *cause);
...
FOUNDATION_EXPORT JavaSqlSQLDataException *create_JavaSqlSQLDataException_initWithNSString_withJavaLangThrowable_(NSString *reason, JavaLangThrowable *cause);
...
FOUNDATION_EXPORT JavaSqlSQLDataException *create_JavaSqlSQLDataException_initWithNSString_withNSString_withJavaLangThrowable_(NSString *reason, NSString *SQLState, JavaLangThrowable *cause);
...
FOUNDATION_EXPORT JavaSqlSQLDataException *create_JavaSqlSQLDataException_initWithNSString_withNSString_withInt_withJavaLangThrowable_(NSString *reason, NSString *SQLState, jint vendorCode, JavaLangThrowable *cause);
