...
//  source: /Users/nestseraualia/devel/j2objc-aleks/guava/android/build_result/java/com/google/common/eventbus/AsyncEventBus.java
//
...
- (instancetype)initWithComGoogleCommonEventbusSubscriberExceptionHandler:(id<ComGoogleCommonEventbusSubscriberExceptionHandler>)arg0 NS_UNAVAILABLE;

- (instancetype)initWithNSString:(NSString *)arg0 NS_UNAVAILABLE;

- (instancetype)initWithNSString:(NSString *)arg0
  withJavaUtilConcurrentExecutor:(id<JavaUtilConcurrentExecutor>)arg1
withComGoogleCommonEventbusDispatcher:(ComGoogleCommonEventbusDispatcher *)arg2
withComGoogleCommonEventbusSubscriberExceptionHandler:(id<ComGoogleCommonEventbusSubscriberExceptionHandler>)arg3 NS_UNAVAILABLE;
