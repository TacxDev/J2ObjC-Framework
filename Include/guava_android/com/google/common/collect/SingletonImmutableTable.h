...
//  source: /Users/nestseraualia/devel/j2objc-aleks/guava/android/build_result/java/com/google/common/collect/SingletonImmutableTable.java
//
...
- (instancetype)initPackagePrivateWithComGoogleCommonCollectTable_Cell:(id<ComGoogleCommonCollectTable_Cell>)cell;

- (instancetype)initPackagePrivateWithId:(id)rowKey
                                  withId:(id)columnKey
                                  withId:(id)value;
