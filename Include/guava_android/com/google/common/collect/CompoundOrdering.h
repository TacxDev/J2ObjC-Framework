...
//  source: /Users/nestseraualia/devel/j2objc-aleks/guava/android/build_result/java/com/google/common/collect/CompoundOrdering.java
//
...
- (instancetype)initPackagePrivateWithJavaUtilComparator:(id<JavaUtilComparator>)primary
                                  withJavaUtilComparator:(id<JavaUtilComparator>)secondary;

- (instancetype)initPackagePrivateWithJavaLangIterable:(id<JavaLangIterable>)comparators;
