...
//  source: /Users/nestseraualia/devel/j2objc-aleks/guava/android/build_result/java/com/google/common/collect/UnmodifiableSortedMultiset.java
//
...
- (instancetype)initPackagePrivateWithComGoogleCommonCollectSortedMultiset:(id<ComGoogleCommonCollectSortedMultiset>)delegate;

- (id<JavaUtilNavigableSet>)createElementSet;

// Disallowed inherited constructors, do not use.

- (instancetype)initWithComGoogleCommonCollectMultiset:(id<ComGoogleCommonCollectMultiset>)arg0 NS_UNAVAILABLE;
