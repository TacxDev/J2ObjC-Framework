...
//  source: /Users/nestseraualia/devel/j2objc-aleks/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xpath/axes/RTFIterator.java
//
...
- (instancetype)initWithOrgApacheXpathNodeSetDTM:(OrgApacheXpathNodeSetDTM *)arg0 NS_UNAVAILABLE;

- (instancetype)initWithOrgW3cDomNodeList:(id<OrgW3cDomNodeList>)arg0
           withOrgApacheXpathXPathContext:(OrgApacheXpathXPathContext *)arg1 NS_UNAVAILABLE;

- (instancetype)initWithOrgW3cDomTraversalNodeIterator:(id<OrgW3cDomTraversalNodeIterator>)arg0
                        withOrgApacheXpathXPathContext:(OrgApacheXpathXPathContext *)arg1 NS_UNAVAILABLE;
