...
//  source: /Users/nestseraualia/devel/j2objc-aleks/guava/build_result/java/com/google/common/collect/ImmutableSet.java
//
...
#endif
#ifdef INCLUDE_ComGoogleCommonCollectImmutableSet_CachingAsList
...
#if !defined (ComGoogleCommonCollectImmutableSet_CachingAsList_) && (INCLUDE_ALL_ComGoogleCommonCollectImmutableSet || defined(INCLUDE_ComGoogleCommonCollectImmutableSet_CachingAsList))
#define ComGoogleCommonCollectImmutableSet_CachingAsList_

@class ComGoogleCommonCollectImmutableList;

@interface ComGoogleCommonCollectImmutableSet_CachingAsList : ComGoogleCommonCollectImmutableSet
...
J2OBJC_EMPTY_STATIC_INIT(ComGoogleCommonCollectImmutableSet_CachingAsList)

FOUNDATION_EXPORT void ComGoogleCommonCollectImmutableSet_CachingAsList_init(ComGoogleCommonCollectImmutableSet_CachingAsList *self);

J2OBJC_TYPE_LITERAL_HEADER(ComGoogleCommonCollectImmutableSet_CachingAsList)
...
@interface ComGoogleCommonCollectImmutableSet_Indexed : ComGoogleCommonCollectImmutableSet_CachingAsList
...
- (instancetype)initWithBoolean:(jboolean)subclass;
