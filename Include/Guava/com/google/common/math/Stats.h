...
//  source: /Users/nestseraualia/devel/j2objc-aleks/guava/build_result/java/com/google/common/math/Stats.java
//
...
+ (ComGoogleCommonMathStats *)ofWithJavaUtilStreamDoubleStream:(id<JavaUtilStreamDoubleStream>)values;

+ (ComGoogleCommonMathStats *)ofWithIntArray:(IOSIntArray *)values;

+ (ComGoogleCommonMathStats *)ofWithJavaUtilStreamIntStream:(id<JavaUtilStreamIntStream>)values;
...
+ (ComGoogleCommonMathStats *)ofWithJavaUtilStreamLongStream:(id<JavaUtilStreamLongStream>)values;
