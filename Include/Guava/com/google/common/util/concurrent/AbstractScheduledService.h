...
//  source: /Users/nestseraualia/devel/j2objc-aleks/guava/build_result/java/com/google/common/util/concurrent/AbstractScheduledService.java
//
...
+ (ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler *)newFixedDelayScheduleWithJavaTimeDuration:(JavaTimeDuration *)initialDelay
                                                                                          withJavaTimeDuration:(JavaTimeDuration *)delay OBJC_METHOD_FAMILY_NONE;
...
+ (ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler *)newFixedRateScheduleWithJavaTimeDuration:(JavaTimeDuration *)initialDelay
                                                                                         withJavaTimeDuration:(JavaTimeDuration *)period OBJC_METHOD_FAMILY_NONE;
...
- (instancetype)initWithJavaTimeDuration:(JavaTimeDuration *)delay;
...
FOUNDATION_EXPORT void ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_Schedule_initWithJavaTimeDuration_(ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_Schedule *self, JavaTimeDuration *delay);

FOUNDATION_EXPORT ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_Schedule *new_ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_Schedule_initWithJavaTimeDuration_(JavaTimeDuration *delay) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_Schedule *create_ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_Schedule_initWithJavaTimeDuration_(JavaTimeDuration *delay);
