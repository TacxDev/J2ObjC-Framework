...
//  source: /Users/nestseraualia/devel/j2objc-aleks/guava/build_result/java/com/google/common/util/concurrent/AtomicDoubleArray.java
//
...
- (jdouble)accumulateAndGetWithInt:(jint)i
...
- (jdouble)getAndAccumulateWithInt:(jint)i
                        withDouble:(jdouble)x
withJavaUtilFunctionDoubleBinaryOperator:(id<JavaUtilFunctionDoubleBinaryOperator>)accumulatorFunction;
...
- (jdouble)getAndUpdateWithInt:(jint)i
withJavaUtilFunctionDoubleUnaryOperator:(id<JavaUtilFunctionDoubleUnaryOperator>)updaterFunction;
...
- (jdouble)updateAndGetWithInt:(jint)i
withJavaUtilFunctionDoubleUnaryOperator:(id<JavaUtilFunctionDoubleUnaryOperator>)updaterFunction;
