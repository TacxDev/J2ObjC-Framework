...
//  source: /Users/nestseraualia/devel/j2objc-aleks/guava/build_result/java/com/google/common/util/concurrent/Monitor.java
//
...
- (jboolean)enterWithJavaTimeDuration:(JavaTimeDuration *)time;
...
- (jboolean)enterInterruptiblyWithJavaTimeDuration:(JavaTimeDuration *)time;
...
- (ComGoogleCommonUtilConcurrentMonitor_Guard *)newGuardWithJavaUtilFunctionBooleanSupplier:(id<JavaUtilFunctionBooleanSupplier>)isSatisfied OBJC_METHOD_FAMILY_NONE;
