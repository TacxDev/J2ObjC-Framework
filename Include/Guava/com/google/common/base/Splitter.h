...
//  source: /Users/nestseraualia/devel/j2objc-aleks/guava/build_result/java/com/google/common/base/Splitter.java
//
...
- (id<JavaUtilStreamStream>)splitToStreamWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence;
